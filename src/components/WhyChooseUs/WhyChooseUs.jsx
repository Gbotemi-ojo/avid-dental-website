...
const features = [
  ...
  },
  {
    ...
    text: 'Our Ikeja clinic is easily accessible for all Lagos residents.',
  },
];
        ...
        <div className="why-choose-us-header">
          <div className="why-choose-us-title-block">
            ...
            <h2 className="section-title">
              Why Choose Avid Dental Clinic in Lagos?
            </h2>
          </div>
          <div className="why-choose-us-description">
            <p>
              At Avid Dental Clinic in Lagos, we prioritize patient-focused
