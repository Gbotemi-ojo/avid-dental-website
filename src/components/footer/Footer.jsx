    ...
    <footer className="footer-section">
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-column footer-info">
            <Link to="/" className="footer-logo">
              <Logo />
              <span>Avid DENTAL</span>
            </Link>
            <p>
              Ile Zik Bus Stop, 601 Agege Motor Rd<br />
              Ile Zik, Ikeja 101233, Lagos
            </p>
            <a href="tel:07030708877" className="footer-phone">0901 645 9100</a>
            <div className="footer-socials">
              <a href="https://web.facebook.com/people/Avid-Dental/61562784249253/?_rdc=1&_rdr#/" target="_blank" rel="noopener noreferrer"><FaFacebook size={24} /></a>
              <a href="https://www.instagram.com/avid_dental_clinic/" target="_blank" rel="noopener noreferrer"><FaInstagram size={24} /></a>
              <a href="https://www.tiktok.com/@avid_dental_clinic" target="_blank" rel="noopener noreferrer"><FaTiktok size={24} /></a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">© Avid Dental Clinic. All Rights Reserved.</p>
