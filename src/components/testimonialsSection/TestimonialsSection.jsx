...
const testimonialData = [
  ...
  {
    stars: 5,
    text: "My experience at Avid Dental Clinic was one of the best I've had. They saved me from a wrong diagnosis. The staff are very polite and friendly, and the environment is clean and calming. The doctors took their time to explain procedures clearly and honestly and ensured I was comfortable throughout. Definitely my go-to clinic and one I would recommend to all my friends and family.",
    author: 'Oluwatomisin Gbadebo',
    timeAgo: 'a month ago',
  },
  {
    stars: 5,
    text: '"The staff were really gentle and friendly, they made me feel at ease throughout my appointment. They took their time explaining everything clearly. I highly recommend their services." Avid dental clinic.',
      ...
      <div className="testimonials-container">
        ...
        <div className="testimonials-header">
          ...
          <p className="section-subheading">
            Hear from patients who trust <strong>Avid Dental Clinic</strong> for everything
