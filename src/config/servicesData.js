...
export const allServices = [
  {
    ...
    introPara: 'At Avid Dental Clinic, we offer professional dental consultations in Lagos to help you understand your oral health and choose the right treatment plan.',
